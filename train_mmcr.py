...
from src.loss_function import mmcr_loss
...
@gin.configurable
def train(config, dataset_path, save_path, lr, wd, batch_size, n_epochs, nummodalities, seed,
          other_callbacks: list):
    _CONFIG['name'] = config
